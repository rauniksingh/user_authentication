...
class Helper {
    ...
    constructor() {
      ...
      port: 465,
      service: "Gmail",
      auth: { user: process.env.email, pass: process.env.emailPassword },
      secure: true
    });

   }

  async sendMail(userDocs) {
    
    let link = "http://"+process.env.host+"/api/v1/user/verify?id="+userDocs._id;
    ...
    <tr>
      <td align="center">
        <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td class="email-masthead">
              <a class="email-masthead_name">Indorse</a>
            </td>
          </tr>
          <!-- Email Body -->
          <tr>
              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    ...
                    <p>Thanks for signing up for Indorse! We're excited to have you as an early user.</p>
                    <!-- Action -->
                    ...
                    <p>Thanks,<br>The Indorse Team</p>
                    <!-- Sub copy -->
        ...
        let mailOptions = { 
            from: `Indorse `,
            to: userDocs.email,
            subject: 'Indorse | Registration Successful',
            html: html
        };
